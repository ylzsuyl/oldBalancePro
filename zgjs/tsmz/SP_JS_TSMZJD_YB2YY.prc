CREATE OR REPLACE PROCEDURE SP_JS_TSMZJD_YB2YY
(
...
BEGIN
	...
	SELECT COUNT(*) INTO LN_COUNT FROM VW_JS_TSMZJS
...
EXCEPTION   WHEN ERR_INS_MZJD THEN
       	   ...
       	   WHEN ERR_SEL_HBCS THEN
               PO_SIGN := -7412;
    	         ROLLBACK;
    	         INSERT INTO JS_ERRLOG(CWH000,JDCWXX,XXCWXX,CCDF00,CZDX00,CZY000) VALUES
         		   (PO_SIGN,'从表BM_JSBLB0查找支付能力系数时错误!',V_SQLERRM,'结算->SP_JS_TSMZJD_YB2YY',pi_FWWDBH,pi_czyuan);
       	      COMMIT;
