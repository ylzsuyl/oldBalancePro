CREATE OR REPLACE PROCEDURE SP_JS_gwybz_bxsfb0_pt
(v_qsrq00 IN char,
v_jzrq00 IN char,
v_ret OUT number)
as
...
begin
open mycursor for
 Select * From yy_bxsfb0 Where jsfsbh = '01' and gwyjb0 in ('11','12') And bxrq00>=v_qsrq00 And bxrq00<=v_jzrq00 
